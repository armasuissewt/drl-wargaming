# flytozurich_sim_mcts_policy.py
#
# Solve the FlyToZurich problem with the MCTS policy-parallel algorithm
#
...
def train_new():
    config = {
        # --- Environment
        'env_class': 'environments.flytozurich.wrappers.flytozurich_sim_wrappers.SimFtzObsRewAdapterEnv',
        ...
        'env_reset_seed': None,
        'env_restore_mode': 'deepcopy',  # save_restore, deepcopy
        ...
        'checkpoint_freq': 100,
        'verbose': True,
        'logging_interval_secs': 10,  # Do not set too low
        'logging_aggregation_epochs': 20,
        'policy_train_max_rate': None,  # None or int
        'render_interval': 2,  # >0 for rendering
        'render_max_per_interval': 1,
        'workers_logging': False,
        # --- Evaluation
        'evaluation_config': {
            'reset_minmax_each_episode': True,
